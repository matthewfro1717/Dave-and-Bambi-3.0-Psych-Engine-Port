...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		//['Philly Glow', "Exclusive to Week 3\nValue 1: 0/1/2 = OFF/ON/Reset Gradient\n \nNo, i won't add it to other weeks."],	I won't add it, don't try
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_hidegf = new FlxUICheckBox(check_Trails.x, check_bfTrails.y+30, null, null, "Hide GF", 100);
		check_hidegf.checked = _song.hidegf;
		check_hidegf.callback = function()
		{
			_song.hidegf = check_hidegf.checked;
		};
		...
		tab_group_song.add(check_hidegf);
